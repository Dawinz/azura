...
$route['v1/wishlist/products'] = 'v1/wishlist_products';
$route['v1/buyer/orders'] = 'v1/buyer_orders';
$route['v1/buyer/order'] = 'v1/buyer_order';
$route['v1/wallet/summary'] = 'v1/wallet_summary';
$route['v1/notifications'] = 'v1/notifications_feed';
$route['v1/product/reviews'] = 'v1/product_reviews_list';
