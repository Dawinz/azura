...
$config['csrf_exclude_uris'] = array('iyzico-payment-post', 'stripe-payment-post', 'mds-run-internal-cron', 'v1/auth/login', 'v1/user/register', 'v1/user/delete', 'v1/create_user', 'v1/create_admin', 'v1/checkout/selcom/init', 'selcom-payment-webhook', 'v1/demo/seed-catalog');
