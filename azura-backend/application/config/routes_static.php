...
$route['selcom-payment-post']['POST'] = 'cart_controller/selcom_payment_post';
$route['selcom-payment-return'] = 'cart_controller/selcom_payment_return';
$route['selcom-payment-webhook']['POST'] = 'cart_controller/selcom_payment_webhook';
...
$route['twocheckout-payment-post'] = 'cart_controller/twocheckout_payment_post';
//earnings
...
$route["mds-run-internal-cron"]['POST'] = "ajax_controller/run_internal_cron";